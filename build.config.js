...
exports.gulpConf = {
   ...
   * 编译后路径
   * eg: htmlDest: '',  页面路径: dist/index.html, 静态资源: dist/css, dist/images, dist/js, dist/libs
   * eg: htmlDest: 'bundle', 页面路径: bundle/index.html, 静态资源: bundle/css, bundle/images, bundle/js, bundle/libs
   * eg: htmlDest: 'bundle/pages', 页面路径: bundle/pages/index.html, 静态资源: bundle/css, bundle/images, bundle/js, bundle/libs
   * eg: htmlDest: 'bundle/other/foo', 页面路径: bundle/other/foo/index.html, 静态资源: bundle/other/css, bundle/other/images, bundle/other/js, bundle/other/libs
   */
